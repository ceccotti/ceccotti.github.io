...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-9314704.589664, 4375286.374144, -8375914.818613, 4959209.992680], maxZoom: 28, minZoom: 10
    })
});
...
map.addControl(layerSwitcher);
    ...
    var searchLayer = new ol.SearchLayer({
      layer: lyr_Majorityofvotescastperparty2,
      colName: 'COUNTYNAME',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([-9314704.589664, 4375286.374144, -8375914.818613, 4959209.992680], map.getSize());
